...
query the ultrasonic sensor, buzz, and test obstacle avoidance.

Requires: pip install pyserial
Usage:    python3 firmware/arin_serial_test.py [PORT] [BAUD]
"""
...
def clamp_speed(value):
    try:
        ...
        return 200
    return min(ALLOWED_MOTOR_SPEED[1], max(ALLOWED_MOTOR_SPEED[0], speed))
...
def main():
    ...
    print("================================\n")
    print("Commands:")
    print("  MOVE:FWD:150        Drive forward (obstacle auto-avoid turns L/R)")
    print("  MOVE:BACK:150       Drive backward")
    print("  TURN:LEFT:150 / TURN:RIGHT:150")
    print("  STOP")
    print("  GET_DISTANCE        Ping ultrasonic")
    print("  GET_STATUS          Full robot state")
    print("  BEEP:500            Buzz for 500ms")
    ...
    try:
        while True:
            ...
            # Normalize motor commands: ensure speed is 0-255
